...
public class StudentRepositoryTests {
	...
	public void given_when_then()
	{
		...
		StudentEntity student = StudentEntity.builder()
				.studentName("Vaibhu")
				 .studentAge(22)
				 .studentEmail("vaibhu@gmail.com")
				 .studentGender("male")
				 .studentPassword("Vaibhu@123")
											 .build();
	...
	public void givenStudentObject_whenUpdatedStudent_thenReturnedUpdatedStudent()
	{
		...
		studentdb.setStudentEmail("vaibhu123@gmail.com");
		StudentEntity updatedStudent=studentRepository.save(studentdb);
		
		//then
		Assertions.assertThat(updatedStudent.getStudentEmail()).isEqualTo("vaibhu123@gmail.com");
